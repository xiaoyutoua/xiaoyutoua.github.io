/*
    此代码为星空的js代码，
    代码用来描述星星在画布上的运动轨迹
    _config.butterfly.yml中的inject中引用
*/
    ...
    function y() {
        this.reset = function () {
            this.giant = m(3),
                ...
                this.x = l(0, n - 10), this.y = l(0, e),
                this.r = l(1.1, 2.6), this.dx = l(t, 6 * t) + (this.comet + 1 - 1) * t * l(50, 120) + 2 * t,
                this.dy = -l(t, 6 * t) - (this.comet + 1 - 1) * t * l(50, 120),
                this.fadingOut = null,
                this.fadingIn = !0, this.opacity = 0,
            ...
            this.fadeOut = function () {
                this.fadingOut && (this.fadingOut = !(this.opacity < 0),
                    this.opacity -= this.do / 2, (this.x > n || this.y < 0) && (this.fadingOut = !1, this.reset()))
            },
            this.draw = function () {
                if (h.beginPath(), this.giant) {
                    h.fillStyle = "rgba(" + a + "," + this.opacity + ")", h.arc(this.x, this.y, 2, 0, 2 * Math.PI, !1)
                }
                else if (this.comet) {
                ...
                } else h.fillStyle = "rgba(" + r + "," + this.opacity + ")", h.rect(this.x, this.y, this.r, this.r); h.closePath(), h.fill()
            },
            this.move = function () {
